...
Regular.prototype.__proto__ = Map.prototype;
Regular.prototype.constructor = Regular;


Regular.prototype.add = function(task) {
  let scheduled;
  for (const [meta, alreadyPlannedTask] of this) {
    if (
      meta.weekFoundation === task.weekFoundation &&
      meta.weekNumber === task.weekNumber &&
      meta.weekDay === task.weekDay
    ) {
      scheduled = true;
    }
  }
